                    ...
                    background: FadeIn(
                      ...
                      child: ShaderMask(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl: ApiConstaces.imageUrl(state.movieDetail!.backDropPath),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
  ...
  builder: (context, state) {
    return SliverGrid(
      delegate: SliverChildBuilderDelegate(
        (context, index) {
          final recommendation = state.recommend[index];
          return FadeInUp(
            from: 20,
            duration: const Duration(milliseconds: 500),
            child: ClipRRect(
              ...
              child: CachedNetworkImage(
                imageUrl: ApiConstaces.imageUrl(recommendation.backDropPath!),
        ...
        childCount: state.recommend.length,
      ),
